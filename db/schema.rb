...
ActiveRecord::Schema[7.1].define(version: 2024_07_31_154629) do
  ...
  create_table "quiz_categories", force: :cascade do |t|
    ...
    t.index ["quiz_id", "category_id"], name: "index_quiz_categories_on_quiz_id_and_category_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "line_notification", default: true, null: false
  end
