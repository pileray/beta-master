...
Rails.application.config.sorcery.configure do |config|
  ...
  config.line.key = Rails.application.credentials.line_login.channel_id
  config.line.secret = Rails.application.credentials.line_login.secret_key
  config.line.callback_url = Settings.line_callback_url.url
